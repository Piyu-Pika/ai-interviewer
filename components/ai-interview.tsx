...
import { ArrowRight, Loader2, Mic, PauseCircle, PlayCircle, Video, VideoOff } from 'lucide-react'
                ...
                <div className="bg-card border rounded-lg p-4">
                  ...
                  <div className="flex justify-between mt-3">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => interview.videoRecorder.toggleVideo()}
                    >
                      {interview.videoState.isVideoOn ? (
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => interview.videoRecorder.toggleMicrophone()}
                    >
