    ...
    <footer className="border-t bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-semibold mb-4">AI Interviewer</h3>
            <p className="text-sm text-muted-foreground">
              Revolutionizing the interview process with AI-powered technology.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/request-demo" className="text-sm text-muted-foreground hover:text-foreground">
                  Request Demo
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/contact-sales" className="text-sm text-muted-foreground hover:text-foreground">
                  Contact Sales
                </Link>
              </li>
            </ul>
